...
namespace SimbirsoftSummerIntensive.Tests
{
    public class CheckRightInputData_Test
    {
        ...
        {
            ICheckRightInputData act = new CheckRightUrl();
            bool result = act.CheckRightInputData(inputData);
        ...
        {
            ICheckRightInputData act = new CheckRightFolderPath();
            bool result = act.CheckRightInputData(inputData);
        ...
        {
            ICheckRightInputData act = new CheckRightConnectionString();
            bool result = act.CheckRightInputData(inputData);
